  ...
  return (
    <Card sx={[cardStyle, {flexDirection:'column'}]}>
      ...
      <Typography sx={{ width:'100%', fontSize:'12px'}}>
        Share your style and size preferences for tailored recommendations.
      </Typography>
      <Card sx={[cardStyle, { p:0, background:'none', boxShadow:'none', borderRadius:0, mt: 2, }]}>
        <TableRowItem title="Tops" value={user.firstName} />
        <TableRowItem title="Bottoms" value={user.lastName} />
        <TableRowItem title="Outerwear" value={user.email} />
        <TableRowItem title="Accessories" value={user.phone} />
        {/* <TableRowItem title="Birth date" value={format(new Date(user.dateOfBirth), "dd MMM, yyyy")} /> */}
      </Card>
      <Card sx={[cardStyle, { p:0, background:'none', boxShadow:'none', borderRadius:0, mt: 2, }]}>
        <TableRowItem title="Style" value={user.firstName} />
        <TableRowItem title="Fit type" value={user.lastName} />
        <TableRowItem title="Preferred Brands" value={user.email} />
        <TableRowItem title="Preferred Colors" value={user.phone} />
        {/* <TableRowItem title="Birth date" value={format(new Date(user.dateOfBirth), "dd MMM, yyyy")} /> */}
      </Card>
    </Card>
