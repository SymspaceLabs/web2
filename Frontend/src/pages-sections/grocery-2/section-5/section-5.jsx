...
import { H5, Paragraph } from "../../../components/Typography"; // STYLED COMPONENTS

import { StyledCard, StyledQuote, StyledAvatar, StyledContent, StyledGridContainer } from "./styles"; // CUSTOM DATA MODEL
...
export default function Section5({
  ...
  return <div className="mb-3">
      <Carousel slidesToShow={1} spaceBetween={0}>
        {testimonials.map((data, ind) => <StyledCard key={ind}>
            <StyledContent>
