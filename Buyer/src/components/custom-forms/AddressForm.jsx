...
// This component renders the input fields for an address and displays validation errors.
// It receives 'data' (current address values), 'onChange' (callback for input changes),
// 'color' (for styling), and 'errors' (an object containing field-specific error messages).
// =========================================================
