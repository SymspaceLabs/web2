    ...
    return (
        <FlexBox flexDirection="column" gap={3} sx={{ width: '100%' }}>
            ...
            <FlexBox justifyContent="center" flexDirection={{xs:"column", sm:"row"}} gap={3} width="100%">
                <SymTextField title="Card Number" value={cardNo} placeholder="Card Number" onChange={handleCardNoChange} toolTipText={toolTipText.cardNo} color={color} />
                <SymTextField title="Expires On" value={expiryMonth} placeholder="Month" onChange={handleExpiryMonthChange} toolTipText={toolTipText.ExpiryMonth}  color={color}  />
                <SymTextField title="&nbsp;" value={expiryYear} placeholder="Year" onChange={handleExpiryYearChange} toolTipText={toolTipText.expiryYear}  color={color}  />
                <SymTextField title="CVV" value={cvv} placeholder="Three Digit Code" onChange={handleCvvChange} charLimit={3}  color={color}  />
            </FlexBox>

            {/* Bank Name || Acc Holder Name */}
            <FlexBox justifyContent="center" flexDirection={{xs:"column", sm:"row"}} gap={3} width="100%">
                <SymTextField title="Card Holder's Name" value={cardHolderName} placeholder="Full Name" onChange={handleCardHolderNameChange} color={color} />
            </FlexBox>
