    ...
    >
      <div className="relative z-[1] flex flex-col gap-[10px] sm:gap-[25px]">
        ...
        <div className="flex justify-end">
          <Link href={btnUrl}>
            <Button
              className="font-elemental rounded-[30px] text-[11px] text-[#2F2F2F] px-4 shadow-[0px_1px_24px_-1px_rgba(0,0,0,0.18)] backdrop-blur-[10px] cursor-pointer transition-all duration-200 hover:brightness-90"
              style={{
                background:
